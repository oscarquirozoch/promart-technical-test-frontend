...
import { formatDate, legalAgeValidation } from '../../../helpers/general.helper'
...
const CreateClientPage: React.FC = () => {
    ...
    const { startSaveClient } = useClientStore()
    ...
    const handleSubmitForm = async (value: ICreateClient) => {
        const response = await startSaveClient({
            ...value,
            ...
            <div className='container'>
                ...
                <Card className='mt-3'>
                    <form onSubmit={handleSubmit}>
                        ...
                        <Button type='submit' label='Registrar' iconPos='right' className='mb-3 pl-4 pr-4' />
                    </form>
                </Card>
